...
class Vaz2107 private constructor() : Car {
    ...
    companion object : CarBuilder {
        ...
        fun test(vaz2107: Vaz2107) {
            ...
            println("${MODEL}: Топливо: ${vaz2107.carOutput.getFuelContents()}")
        }
    ...
    override fun toString(): String {
        ...
        return "Vaz2107(plates=$plates, wheelAngle=$wheelAngle, currentSpeed=$currentSpeed, fuelTank=${tankMouth.getContents()})"
    }
